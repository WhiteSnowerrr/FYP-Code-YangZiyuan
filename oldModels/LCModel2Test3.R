...
database$income_d = database$income_d/1000
...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  ...
  V=list()
  V[["class_a"]] = delta_a + g_off3_a*qoffice_3 + g_off4_a*qoffice_4 + g_hou_a*qhousehold_3 + g_incn_a*income_2 + g_incd_a*income_d + g_car_a*private_car + g_csrs1_a*cs_rs_1_1 + g_csrs2_a*cs_rs_1_2 + g_fam2_a*qfamily_2 + g_fam3_a*qfamily_3 + g_fam5_a*qfamily_5 + g_lic_a*license + g_att1_a*att_pt_5 + g_att2_a*att_pt_6 + g_age_a*age + g_gen_a*gender + g_edu_a*edu     
  V[["class_b"]] = 0
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  for(s in 1:2){
    ...
    V[["pt"]]  = asc_pt + b_cost_value[[s]] * pt1_cost_s + b_tt_value[[s]] * commuting_days_s * pt1_tt_s + b_crowd_value[[s]] * pt1_crowd_s + b_trans_value[[s]] * pt1_trans_s
    V[["cs"]]  = asc_cs + b_cost_value[[s]] * cs2_cost_s + b_tt_value[[s]] * commuting_days_s * cs2_tt_s + b_disin_value[[s]] * cs2_disin_s
    V[["rs"]]  = asc_rs + b_cost_value[[s]] * rs3_cost_s + b_tt_value[[s]] * commuting_days_s * rs3_tt_s + b_share_value[[s]] * rs3_share_s
