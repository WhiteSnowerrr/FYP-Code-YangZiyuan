...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  ...
  V=list()
  V[["class_a"]] = (1-mode_2023)*1000
  V[["class_b"]] = mode_2023*1000
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  for(s in 1:2){
    ...
    if(s==1){
      T1 = list()
      T1[[paste0("Class_",s,'_best')]] = apollo_mnl(mnl_settings_best, functionality)
      T1[[paste0("Class_",s,'_worst')]] = apollo_mnl(mnl_settings_worst, functionality)
      ### Combined model
      T1 = apollo_combineModels(T1, apollo_inputs, functionality)
      
      ### Take product across observation for same individual
      T1 = apollo_panelProd(T1, apollo_inputs ,functionality)
      T1[[paste0("Class_",s)]] = T1[["model"]]
    }else{
      T2 = list()
      T2[[paste0("Class_",s,'_best')]] = apollo_mnl(mnl_settings_best, functionality)
      T2[[paste0("Class_",s,'_worst')]] = apollo_mnl(mnl_settings_worst, functionality)
      ### Combined model
      T2 = apollo_combineModels(T2, apollo_inputs, functionality)
      
      ### Take product across observation for same individual
      T2 = apollo_panelProd(T2, apollo_inputs ,functionality)
      T2[[paste0("Class_",s)]] = T2[["model"]]
    }

  }
  P[["Class_1"]] = T1[["Class_1"]]
  P[["Class_2"]] = T2[["Class_2"]]
