...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  ...
  V=list()
  V[["class_a"]] = delta_a + g_off_a*qoffice_3 + g_hou_a*qhousehold_3 + g_inc_a*income_2 + g_car_a*private_car + g_csrs_a*cs_rs_1_1 + g_fam_a*qfamily_3 + g_lic_a*license + g_att1_a*att_pt_5 + g_att2_a*att_pt_6 + g_age_a*age + g_gen_a*gender + g_edu_a*edu     
  V[["class_b"]] = 0
