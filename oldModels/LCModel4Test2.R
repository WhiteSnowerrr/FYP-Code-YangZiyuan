...
apollo_beta = apollo_readBeta(apollo_beta, apollo_fixed, "LC_tt", overwriteFixed=FALSE)



apollo_lcPars=function(apollo_beta, apollo_inputs){
  lcpars = list()
  lcpars[["b_tt_value"]] = list(b_tt, b_tt+b_tt_shift, b_tt+b_tt_shift2)
  lcpars[["b_cost_value"]] = list(b_cost, b_cost+b_cost_shift, b_cost+b_cost_shift2)
  lcpars[["b_trans_value"]] = list(b_trans, b_trans+b_trans_shift, b_trans+b_trans_shift2)
  lcpars[["b_crowd_value"]] = list(b_crowd, b_crowd+b_crowd_shift, b_crowd+b_crowd_shift2)
  lcpars[["b_disin_value"]] = list(b_disin, b_disin+b_disin_shift, b_disin+b_disin_shift2)
  lcpars[["b_share_value"]] = list(b_share, b_share+b_share_shift, b_share+b_share_shift2)
  lcpars[["b_pta_value"]] = list(b_pta, b_pta+b_pta_shift, b_pta+b_pta_shift2)
  lcpars[["b_csa_value"]] = list(b_csa, b_csa+b_csa_shift, b_csa+b_csa_shift2)
  lcpars[["b_rsa_value"]] = list(b_rsa, b_rsa+b_rsa_shift, b_rsa+b_rsa_shift2)
...
zp1 <- zp1 + guides(fill = guide_legend(reverse=TRUE))  +
  geom_text(aes(x=L2,y=ly,label=paste(round(value/sum(value)*100,2),"%")),size=2)
print(zp1)
