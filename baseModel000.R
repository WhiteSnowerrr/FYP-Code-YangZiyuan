...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  b_disin_value  = b_disin
  b_share_value   = b_share 
  b_crowd_value   = b_crowd 
  b_trans_value   = b_trans 
  
  ### List of utilities: these must use the same names as in mnl_settings, order is irrelevant
  V = list()
  V[["pt"]]  = asc_pt + b_cost_value * pt1_cost_s  + b_tt_value * commuting_days_s * pt1_tt_s + b_pta_value * age_s + b_crowd_value * pt1_crowd_s + b_trans_value * pt1_trans_s
  V[["cs"]]  = asc_cs + b_cost_value * cs2_cost_s  + b_tt_value * commuting_days_s * cs2_tt_s + b_csa_value * age_s + b_disin_value * cs2_disin_s
  V[["rs"]]  = asc_rs + b_cost_value * rs3_cost_s  + b_tt_value * commuting_days_s * rs3_tt_s + b_rsa_value * age_s + b_tt_value * b_share_value * rs3_share_s
